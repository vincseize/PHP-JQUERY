...
<body>
    ...
    <div style="padding: 0 15px;">
        ...
        <ul class="pagination">
            ...
            <li <?php echo $link_active; ?>><a href="<?php echo $page_index;?>?page=1">1</a></li>
            ...
            ?>
            <li <?php echo $link_active; ?>><a href="<?php echo $page_index;?>?page=<?php echo $n_pages_result;?>"><?php echo $n_pages_result;?></a></li>
